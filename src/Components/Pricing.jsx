    ...
    <div name='pricing' className=' w-full text-white my-24'>
      ...
      <div className='max-w-[1240px] mx-auto py-12'>
        <div className='text-center py-8 text-slate-300'>
            ...
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Cupiditate amet aut facere dolore commodi aperiam eaque odio ea ducimus maxime.
            </p>
        </div>

        <div className='grid md:grid-cols-2'>
        <div className='bg-white text-slate-900 m-6 p-8 rounded-2xl shadow-2xl'>
        ...
        <div className='bg-white text-slate-900 m-4 p-8 rounded-3xl shadow-2xl relative'>
        <span className='uppercase px-3 py-1 bg-indigo-200 text-indigo-900 rounded-3xl text-sm'>Premium</span>
            <div>
